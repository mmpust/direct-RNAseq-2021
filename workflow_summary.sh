...
# Step 3: Alignment of RNA reads with minimap2 (see SLURM script, minimap2_run_SLURM.sh)
...
for items in *forward_antisense.bam; do bedtools genomecov -ibam $items -bg  > ${items%.forward_antisense.bam}.genomecov.antisense.bed; done
