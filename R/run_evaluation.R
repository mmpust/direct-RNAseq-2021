...
libsize_plot <- ggplot(n_reads_sense_antisense_L_total, aes(x=id, color=isolate2)) +
  geom_jitter(aes(x=id, y=sqrt(value), fill=isolate2), shape = 15, size=3, width=0.05) +
  theme_pubr(border=TRUE, base_size=11) + coord_flip() + ylab("Number of reads") + xlab("") +
  theme(legend.title = element_blank(), legend.position = c(0.7,0.2), legend.box.background = element_rect()) + 
  scale_color_manual(values=c("orange", "red", "cyan", "darkblue")) + 
  scale_y_continuous(breaks = c(0, 500, 1000), labels=c("0", expression("500"^2), expression("1,000"^2)))

summary_names <- c("ONT_NN2_4h_BR1", "ONT_NN2_4h_BR2", "ONT_NN2_4h_BR3", "ONT_NN2_8h_BR1", "ONT_NN2_8h_BR2", "ONT_NN2_8h_BR3", 
...
pore_capacity_plot <- ggplot(dataset2) + geom_jitter(aes(x=pore_capacity, y=cumsum, color=Run), size=2) +
  geom_point(data=centroids,aes(x=pore_capacity, y=cumsum, color=Run), size=6) + 
  geom_line(aes(x=pore_capacity, y=cumsum, color=Run)) + theme_pubr(border=TRUE,legend = "none",base_size=11) +
  scale_colour_manual(values=c("lightgreen", "aquamarine4", "darkgreen", "yellow", 
                               "black", "navajowhite2", "purple", "pink", "grey", "firebrick", "violet")) +
  xlab("Number of available pores") + ylab("Number of reads") + scale_y_continuous(labels = scales::comma)
size_capacity_plot <- ggarrange(libsize_plot, pore_capacity_plot, nrow=1, labels = c("A", "B"))

# Load input to evaluate read length 
ont_NN2_4h_BR1_antisense <- read_delim("NN2_run/NN2_CS_4h_BR1.sorted.bam.antisense_summary.bed", 
...
ont_NN2_4h_BR2_antisense <- read_delim("NN2_run/antisense_transcription/NN2_CS_4h_BR2.sorted.bam.antisense_summary.bed", 
                                       "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_4h_BR3_antisense <- read_delim("NN2_run/NN2_CS_4h_BR3.sorted.bam.antisense_summary.bed", 
                                       "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_4h_BR1_sense <- read_delim("NN2_run/antisense_transcription/NN2_CS_4h_BR1.sorted.bam.sense_summary.bed",
                                   "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_4h_BR2_sense <- read_delim("NN2_run/antisense_transcription/NN2_CS_4h_BR2.sorted.bam.sense_summary.bed",
                                   "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_4h_BR3_sense <- read_delim("NN2_run/antisense_transcription/NN2_CS_4h_BR3.sorted.bam.sense_summary.bed", 
                                   "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_8h_BR1_antisense <- read_delim("NN2_run/antisense_transcription/NN2_CS_8h_BR1.sorted.bam.antisense_summary.bed", "\t", 
                                       escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_8h_BR2_antisense <- read_delim("NN2_run/NN2_CS_8h_BR2.sorted.bam.antisense_summary.bed", 
                                       "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_8h_BR3_antisense <- read_delim("NN2_run/antisense_transcription/NN2_CS_8h_BR3.sorted.bam.antisense_summary.bed", 
                                       "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_8h_BR1_sense <- read_delim("NN2_run/c_raw_bam_sam/NN2_CS_8h_BR1.sorted.bam.sense_summary.bed", 
                                   "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_8h_BR2_sense <- read_delim("NN2_run/NN2_CS_8h_BR2.sorted.bam.sense_summary.bed", 
                                   "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_8h_BR3_sense <- read_delim("NN2_run/antisense_transcription/NN2_CS_8h_BR3.sorted.bam.sense_summary.bed", 
                                   "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_4h_BR1_antisense <- read_delim("SG17M_run/antisense_transcription/SG17M_CS_4h_BR1.sorted.bam.antisense_summary.bed", 
                                         "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_4h_BR2_antisense <- read_delim("SG17M_run/antisense_transcription/SG17M_CS_4h_BR2.sorted.bam.antisense_summary.bed", 
                                         "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_4h_BR3_antisense <- read_delim("SG17M_run/SG17M_CS_4h_BR3.sorted.bam.antisense_summary.bed", 
                                         "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_4h_BR1_sense <- read_delim("SG17M_run/SG17M_CS_4h_BR1.sorted.bam.sense_summary.bed",
                                     "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_4h_BR2_sense <- read_delim("SG17M_run/antisense_transcription/SG17M_CS_4h_BR2.sorted.bam.sense_summary.bed", 
                                     "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_4h_BR3_sense <- read_delim("SG17M_run/SG17M_CS_4h_BR3.sorted.bam.sense_summary.bed", 
                                     "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_8h_BR1_antisense <- read_delim("SG17M_run/SG17M_CS_8h_BR1.sorted.bam.antisense_summary.bed", 
                                         "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_8h_BR2_antisense <- read_delim("SG17M_run/SG17M_CS_8h_BR2.sorted.bam.antisense_summary.bed", 
                                         "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_8h_BR3_antisense <- read_delim("SG17M_run/SG17M_CS_8h_BR3.sorted.bam.antisense_summary.bed", 
                                         "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_8h_BR1_sense <- read_delim("SG17M_run/SG17M_CS_8h_BR1.sorted.bam.sense_summary.bed", 
                                     "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_8h_BR2_sense <- read_delim("SG17M_run/SG17M_CS_8h_BR2.sorted.bam.sense_summary.bed", 
                             "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_8h_BR3_sense <- read_delim("SG17M_run/SG17M_CS_8h_BR3.sorted.bam.sense_summary.bed", 
                             "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_4h <- data.frame(rbind(ont_NN2_4h_BR1_antisense, ont_NN2_4h_BR2_antisense,
                               ont_NN2_4h_BR3_antisense, ont_NN2_4h_BR1_sense, ont_NN2_4h_BR2_sense, ont_NN2_4h_BR3_sense))
...
ont_NN2_8h <- data.frame(rbind(ont_NN2_8h_BR1_antisense, ont_NN2_8h_BR2_antisense, ont_NN2_8h_BR3_antisense,
                               ont_NN2_8h_BR1_sense, ont_NN2_8h_BR2_sense, ont_NN2_8h_BR3_sense))
...
ont_SG17M_4h <- data.frame(rbind(ont_SG17M_4h_BR1_antisense, ont_SG17M_4h_BR2_antisense, ont_SG17M_4h_BR3_antisense,
                               ont_SG17M_4h_BR1_sense, ont_SG17M_4h_BR2_sense, ont_SG17M_4h_BR3_sense))
...
ont_SG17M_8h <- data.frame(rbind(ont_SG17M_8h_BR1_antisense, ont_SG17M_8h_BR2_antisense, ont_SG17M_8h_BR3_antisense,
                               ont_SG17M_8h_BR1_sense, ont_SG17M_8h_BR2_sense, ont_SG17M_8h_BR3_sense))
...
ont_noNA$loq_qwith <- sqrt(ont_noNA$read_length)
...
length_4h_plot <- ggplot(ont_noNA_4h) + geom_density(aes(x=loq_qwith, color=strand_transcript)) + facet_grid(~isolate) + 
  theme_pubr(border=TRUE, base_size=11) + xlab("RNA read length") + scale_color_manual(values=c("cyan", "blue")) + ylab("Density") + 
  scale_x_continuous(breaks=c(30, 60, 90), labels=c(expression("30"^2), expression("60"^2), expression("90"^2)), limits=c(1,100)) +
  theme(legend.title = element_blank(), legend.position = c(0.1,0.75)) 

length_8h_plot <- ggplot(ont_noNA_8h) + geom_density(aes(x=loq_qwith, color=strand_transcript)) + facet_grid(~isolate) + 
  theme_pubr(border=TRUE, base_size=11, legend = "none") + xlab("RNA read length") +
  scale_color_manual(values=c("cyan", "blue")) + ylab(" ") + scale_x_continuous(breaks=c(30, 60, 90), labels=c(expression("30"^2), 
                              expression("60"^2), expression("90"^2)), limits=c(1,100)) + theme(axis.ticks.y = element_blank())

length_sense_antisense <- ggarrange(length_4h_plot, length_8h_plot, nrow=1, labels=c("B", "C"))
merge_plots2 <- ggarrange(size_capacity_plot, length_sense_antisense, nrow=2, heights = c(1,0.5))
#ggsave(merge_plots2, filename="save_figures/Figure_01.jpeg", device="jpeg", dpi=600, units="cm", width=25.2, height=21.6)
...
kruskal_statistic <- c(nn2_4h_kw$statistic, nn2_8h_kw$statistic, NN2_4h_8h_kw$statistic, 
                       sg17m_4h_kw$statistic, sg17m_8h_kw$statistic, SG17M_4h_8h_kw$statistic, nn2_sg17m_4h_kw$statistic, nn2_sg17m_8h_kw$statistic)

kruskal_pvalue <- c(nn2_4h_kw$p.value, nn2_8h_kw$p.value, NN2_4h_8h_kw$p.value,
                    sg17m_4h_kw$p.value, sg17m_8h_kw$p.value, SG17M_4h_8h_kw$p.value, nn2_sg17m_4h_kw$p.value, nn2_sg17m_8h_kw$p.value)

e2_values <- c(nn2_4h_e2$epsilon.squared, nn2_8h_e2$epsilon.squared, NN2_4h_8h_e2$epsilon.squared,
               sg17m_4h_e2$epsilon.squared, sg17m_8h_e2$epsilon.squared, SG17M_4h_8h_e2$epsilon.squared, nn2_sg17m_4h_e2$epsilon.squared, nn2_sg17m_8h_e2$epsilon.squared)

e2_lower_ci <- c(nn2_4h_e2$lower.ci, nn2_8h_e2$lower.ci, NN2_4h_8h_e2$lower.ci,
                 sg17m_4h_e2$lower.ci, sg17m_8h_e2$lower.ci, SG17M_4h_8h_e2$lower.ci, nn2_sg17m_4h_e2$lower.ci, nn2_sg17m_4h_e2$lower.ci)

e2_upper_ci <- c(nn2_4h_e2$upper.ci, nn2_8h_e2$upper.ci, NN2_4h_8h_e2$upper.ci,
                 sg17m_4h_e2$upper.ci, sg17m_8h_e2$upper.ci, SG17M_4h_8h_e2$upper.ci, nn2_sg17m_4h_e2$upper.ci, nn2_sg17m_8h_e2$upper.ci)
