...
packages <- c('Rsamtools', 'ggplot2', 'ggpubr', 'stringr', 'tidyr', 'readr', 'rcompanion')
...
# Import BAM files
ont_NN2_4h_BR1 <-  scanBam("NN2_run/NN2_CS_4h_BR1.bam")
...
ont_NN2_4h_BR2 <-  scanBam("NN2_run/NN2_CS_4h_BR2.bam")
...
ont_NN2_4h_BR3 <-  scanBam("NN2_run/NN2_CS_4h_BR3.bam")
...
ont_NN2_8h_BR1 <-  scanBam("NN2_run/NN2_CS_8h_BR1.bam")
...
ont_NN2_8h_BR2 <-  scanBam("NN2_run/NN2_CS_8h_BR2.bam")
...
ont_NN2_8h_BR3 <-  scanBam("NN2_run/NN2_CS_8h_BR3.bam")
...
ont_SG17M_4h_BR1 <-  scanBam("SG17M_run/SG17M_CS_4h_BR1.bam")
...
ont_SG17M_4h_BR2 <-  scanBam("SG17M_run/SG17M_CS_4h_BR2.bam")
...
ont_SG17M_4h_BR3 <-  scanBam("SG17M_run/SG17M_CS_4h_BR3.bam")
...
ont_SG17M_8h_BR1 <-  scanBam("SG17M_run/SG17M_CS_8h_BR1.bam")
...
ont_SG17M_8h_BR2 <-  scanBam("SG17M_run/SG17M_CS_8h_BR2.bam")
...
ont_SG17M_8h_BR3 <-  scanBam("SG17M_run/SG17M_CS_8h_BR3.bam")
...
nreads_PA_sense <- c((table(ont_NN2_4h_BR1$strand, ont_NN2_4h_BR1$rname)[1]),(table(ont_NN2_4h_BR2$strand, ont_NN2_4h_BR2$rname)[1]),(table(ont_NN2_4h_BR3$strand, ont_NN2_4h_BR3$rname)[1]),
                     (table(ont_NN2_8h_BR1$strand, ont_NN2_8h_BR1$rname)[1]),(table(ont_NN2_8h_BR2$strand, ont_NN2_8h_BR2$rname)[1]),(table(ont_NN2_8h_BR3$strand, ont_NN2_8h_BR3$rname)[1]),
                     (table(ont_SG17M_4h_BR1$strand, ont_SG17M_4h_BR1$rname)[1]),(table(ont_SG17M_4h_BR2$strand, ont_SG17M_4h_BR2$rname)[1]),(table(ont_SG17M_4h_BR3$strand, ont_SG17M_4h_BR3$rname)[1]),
                     (table(ont_SG17M_8h_BR1$strand, ont_SG17M_8h_BR1$rname)[1]),(table(ont_SG17M_8h_BR2$strand, ont_SG17M_8h_BR2$rname)[1]),(table(ont_SG17M_8h_BR3$strand, ont_SG17M_8h_BR3$rname)[1]))

nreads_ENO_sense  <- c(table(ont_NN2_4h_BR1$strand, ont_NN2_4h_BR1$rname)[4],table(ont_NN2_4h_BR2$strand, ont_NN2_4h_BR2$rname)[4],table(ont_NN2_4h_BR3$strand, ont_NN2_4h_BR3$rname)[4],
                       table(ont_NN2_8h_BR1$strand, ont_NN2_8h_BR1$rname)[4],table(ont_NN2_8h_BR2$strand, ont_NN2_8h_BR2$rname)[4],table(ont_NN2_8h_BR3$strand, ont_NN2_8h_BR3$rname)[4],
                       table(ont_SG17M_4h_BR1$strand, ont_SG17M_4h_BR1$rname)[4],table(ont_SG17M_4h_BR2$strand, ont_SG17M_4h_BR2$rname)[4],table(ont_SG17M_4h_BR3$strand, ont_SG17M_4h_BR3$rname)[4],
                       table(ont_SG17M_8h_BR1$strand, ont_SG17M_8h_BR1$rname)[4],table(ont_SG17M_8h_BR2$strand, ont_SG17M_8h_BR2$rname)[4],table(ont_SG17M_8h_BR3$strand, ont_SG17M_8h_BR3$rname)[4])

nreads_PA_antisense <- c((table(ont_NN2_4h_BR1$strand, ont_NN2_4h_BR1$rname)[2]),(table(ont_NN2_4h_BR2$strand, ont_NN2_4h_BR2$rname)[2]),(table(ont_NN2_4h_BR3$strand, ont_NN2_4h_BR3$rname)[2]),
                         (table(ont_NN2_8h_BR1$strand, ont_NN2_8h_BR1$rname)[2]),(table(ont_NN2_8h_BR2$strand, ont_NN2_8h_BR2$rname)[2]),(table(ont_NN2_8h_BR3$strand, ont_NN2_8h_BR3$rname)[2]),
                         (table(ont_SG17M_4h_BR1$strand, ont_SG17M_4h_BR1$rname)[2]),(table(ont_SG17M_4h_BR2$strand, ont_SG17M_4h_BR2$rname)[2]),(table(ont_SG17M_4h_BR3$strand, ont_SG17M_4h_BR3$rname)[2]),
                         (table(ont_SG17M_8h_BR1$strand, ont_SG17M_8h_BR1$rname)[2]),(table(ont_SG17M_8h_BR2$strand, ont_SG17M_8h_BR2$rname)[2]),(table(ont_SG17M_8h_BR3$strand, ont_SG17M_8h_BR3$rname)[2]))

nreads_ENO_antisense  <- c(table(ont_NN2_4h_BR1$strand, ont_NN2_4h_BR1$rname)[5],table(ont_NN2_4h_BR2$strand, ont_NN2_4h_BR2$rname)[5],table(ont_NN2_4h_BR3$strand, ont_NN2_4h_BR3$rname)[5],
                           table(ont_NN2_8h_BR1$strand, ont_NN2_8h_BR1$rname)[5],table(ont_NN2_8h_BR2$strand, ont_NN2_8h_BR2$rname)[5],table(ont_NN2_8h_BR3$strand, ont_NN2_8h_BR3$rname)[5],
                           table(ont_SG17M_4h_BR1$strand, ont_SG17M_4h_BR1$rname)[5],table(ont_SG17M_4h_BR2$strand, ont_SG17M_4h_BR2$rname)[5],table(ont_SG17M_4h_BR3$strand, ont_SG17M_4h_BR3$rname)[5],
                           table(ont_SG17M_8h_BR1$strand, ont_SG17M_8h_BR1$rname)[5],table(ont_SG17M_8h_BR2$strand, ont_SG17M_8h_BR2$rname)[5],table(ont_SG17M_8h_BR3$strand, ont_SG17M_8h_BR3$rname)[5])
...
colnames(n_reads_sense_antisense) <- c("nreads_PA_sense", "nreads_PA_antisense", "nreads_ENO_sense", "nreads_ENO_antisense")
rownames(n_reads_sense_antisense) <- c("ONT_NN2_4h_BR1", "ONT_NN2_4h_BR2", "ONT_NN2_4h_BR3", "ONT_NN2_8h_BR1", "ONT_NN2_8h_BR2", "ONT_NN2_8h_BR3", "ONT_SG17M_4h_BR1", "ONT_SG17M_4h_BR2", "ONT_SG17M_4h_BR3", "ONT_SG17M_8h_BR1", "ONT_SG17M_8h_BR2", "ONT_SG17M_8h_BR3")
...
n_reads_sense_antisense_L_total <- subset(n_reads_sense_antisense_L, isolate == "nreads_PA_sense" | isolate == "nreads_PA_antisense" | isolate == "nreads_ENO_sense" | isolate == "nreads_ENO_antisense")
n_reads_sense_antisense_L_total$isolate2 <- with(n_reads_sense_antisense_L_total, ifelse(isolate == "nreads_PA_sense", "PA, forward strand",
...
summary_names <- c("ONT_NN2_4h_BR1","ONT_NN2_4h_BR2","ONT_NN2_4h_BR3","ONT_NN2_8h_BR1","ONT_NN2_8h_BR2","ONT_NN2_8h_BR3","ONT_SG17M_4h_BR1","ONT_SG17M_4h_BR2","ONT_SG17M_4h_BR3","ONT_SG17M_8h_BR1","ONT_SG17M_8h_BR2","ONT_SG17M_8h_BR3")
nraw_reads_total <- c(164300,124269,254652,142493,91097,456000,323314,267750,1401492,448244,411871,334857)
nbases <- c(91645543,67762786,103114020,65434441,31702988,260692826,150006926,160857070,547180145,252533658,225927528,98126611)
...
pore_capacity_plot <- ggplot(dataset2) + 
  ...
  theme(axis.text = element_text(size=9),
        axis.title = element_text(size=10)) +
  scale_colour_manual(values=c("lightgreen", "aquamarine4", "darkgreen", "yellow", "black", "navajowhite2", "purple", "pink", "grey", "firebrick", "violet")) +
  xlab("Number of available pores") + ylab("Number of reads") + 
  scale_y_continuous(labels = scales::comma)


size_capacity_plot <- ggarrange(libsize_plot, pore_capacity_plot, nrow=1, labels = c("A", "B"), font.label = list(size = 14, color = "black"), widths = c(1,0.8))
...
ont_NN2_4h_BR1_antisense <- read_delim("NN2_run/antisense_transcription/NN2_CS_4h_BR1.sorted.bam.antisense_summary.bed", "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_4h_BR2_antisense <- read_delim("NN2_run/antisense_transcription/NN2_CS_4h_BR2.sorted.bam.antisense_summary.bed", "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_4h_BR3_antisense <- read_delim("NN2_run/antisense_transcription/NN2_CS_4h_BR3.sorted.bam.antisense_summary.bed", "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_4h_BR1_sense <- read_delim("NN2_run/antisense_transcription/NN2_CS_4h_BR1.sorted.bam.sense_summary.bed", "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_4h_BR2_sense <- read_delim("NN2_run/antisense_transcription/NN2_CS_4h_BR2.sorted.bam.sense_summary.bed","\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_4h_BR3_sense <- read_delim("NN2_run/antisense_transcription/NN2_CS_4h_BR3.sorted.bam.sense_summary.bed", "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_8h_BR1_antisense <- read_delim("NN2_run/antisense_transcription/NN2_CS_8h_BR1.sorted.bam.antisense_summary.bed", "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_8h_BR2_antisense <- read_delim("NN2_run/antisense_transcription/NN2_CS_8h_BR2.sorted.bam.antisense_summary.bed", "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_8h_BR3_antisense <- read_delim("NN2_run/antisense_transcription/NN2_CS_8h_BR3.sorted.bam.antisense_summary.bed", "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_8h_BR1_sense <- read_delim("NN2_run/antisense_transcription/NN2_CS_8h_BR1.sorted.bam.sense_summary.bed", "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_8h_BR2_sense <- read_delim("NN2_run/antisense_transcription/NN2_CS_8h_BR2.sorted.bam.sense_summary.bed", "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_8h_BR3_sense <- read_delim("NN2_run/antisense_transcription/NN2_CS_8h_BR3.sorted.bam.sense_summary.bed", "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_4h_BR1_antisense <- read_delim("SG17M_run/antisense_transcription/SG17M_CS_4h_BR1.sorted.bam.antisense_summary.bed", "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_4h_BR2_antisense <- read_delim("SG17M_run/antisense_transcription/SG17M_CS_4h_BR2.sorted.bam.antisense_summary.bed", "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_4h_BR3_antisense <- read_delim("SG17M_run/antisense_transcription/SG17M_CS_4h_BR3.sorted.bam.antisense_summary.bed", "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_4h_BR1_sense <- read_delim("SG17M_run/antisense_transcription/SG17M_CS_4h_BR1.sorted.bam.sense_summary.bed", "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_4h_BR2_sense <- read_delim("SG17M_run/antisense_transcription/SG17M_CS_4h_BR2.sorted.bam.sense_summary.bed", "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_4h_BR3_sense <- read_delim("SG17M_run/antisense_transcription/SG17M_CS_4h_BR3.sorted.bam.sense_summary.bed", "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_8h_BR1_antisense <- read_delim("SG17M_run/antisense_transcription/SG17M_CS_8h_BR1.sorted.bam.antisense_summary.bed", "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_8h_BR2_antisense <- read_delim("SG17M_run/antisense_transcription/SG17M_CS_8h_BR2.sorted.bam.antisense_summary.bed", "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_8h_BR3_antisense <- read_delim("SG17M_run/antisense_transcription/SG17M_CS_8h_BR3.sorted.bam.antisense_summary.bed", "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_8h_BR1_sense <- read_delim("SG17M_run/antisense_transcription/SG17M_CS_8h_BR1.sorted.bam.sense_summary.bed", 
...
ont_SG17M_8h_BR2_sense <- read_delim("SG17M_run/antisense_transcription/SG17M_CS_8h_BR2.sorted.bam.sense_summary.bed", 
                             "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_SG17M_8h_BR3_sense <- read_delim("SG17M_run/antisense_transcription/SG17M_CS_8h_BR3.sorted.bam.sense_summary.bed", 
                             "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
ont_NN2_4h <- data.frame(rbind(ont_NN2_4h_BR1_antisense,ont_NN2_4h_BR2_antisense,ont_NN2_4h_BR3_antisense,ont_NN2_4h_BR1_sense,ont_NN2_4h_BR2_sense,ont_NN2_4h_BR3_sense))
...
ont_NN2_8h <- data.frame(rbind(ont_NN2_8h_BR1_antisense,ont_NN2_8h_BR2_antisense,ont_NN2_8h_BR3_antisense,ont_NN2_8h_BR1_sense,ont_NN2_8h_BR2_sense,ont_NN2_8h_BR3_sense))
...
ont_SG17M_4h <- data.frame(rbind(ont_SG17M_4h_BR1_antisense,ont_SG17M_4h_BR2_antisense,ont_SG17M_4h_BR3_antisense,ont_SG17M_4h_BR1_sense,ont_SG17M_4h_BR2_sense,ont_SG17M_4h_BR3_sense))
...
ont_SG17M_8h <- data.frame(rbind(ont_SG17M_8h_BR1_antisense,ont_SG17M_8h_BR2_antisense,ont_SG17M_8h_BR3_antisense,ont_SG17M_8h_BR1_sense,ont_SG17M_8h_BR2_sense,ont_SG17M_8h_BR3_sense))
...
length_4h_plot <- ggplot(ont_noNA_4h) + geom_density(aes(x=sqrt_qwith, colour=strand_transcript)) + 
  facet_grid(~isolate) + 
  ...
  scale_x_continuous(breaks=c(30,60,90), 
                     labels=c(expression("30"^2),expression("60"^2),expression("90"^2)),
                     limits=c(10,90)) +
...
length_8h_plot <- ggplot(ont_noNA_8h) + geom_density(aes(x=sqrt_qwith, colour=strand_transcript)) + 
  facet_grid(~isolate) + 
...
plot_length_merge <- ggarrange(nn2_4h_plot_length, nn2_8h_plot_length, sg17m_4h_plot_length, sg18m_8h_plot_length, labels=c("A", "B", "C", "D"), nrow=1)

sample_names <- c("NN2-4h", "NN2-8h", "NN2-4h-8h", "SG17M-4h", "SG17M-8h", "SG17M-4h-8h", "NN2-SG17M (4h)", "NN2-SG17M (8h)")

kruskal_statistic <- c(nn2_4h_kw$statistic, nn2_8h_kw$statistic, NN2_4h_8h_kw$statistic,sg17m_4h_kw$statistic, sg17m_8h_kw$statistic, SG17M_4h_8h_kw$statistic,nn2_sg17m_4h_kw$statistic, nn2_sg17m_8h_kw$statistic)
kruskal_pvalue <- c(nn2_4h_kw$p.value, nn2_8h_kw$p.value, NN2_4h_8h_kw$p.value,sg17m_4h_kw$p.value, sg17m_8h_kw$p.value, SG17M_4h_8h_kw$p.value,nn2_sg17m_4h_kw$p.value, nn2_sg17m_8h_kw$p.value)
e2_values <- c(nn2_4h_e2$epsilon.squared, nn2_8h_e2$epsilon.squared, NN2_4h_8h_e2$epsilon.squared,sg17m_4h_e2$epsilon.squared, sg17m_8h_e2$epsilon.squared, SG17M_4h_8h_e2$epsilon.squared,nn2_sg17m_4h_e2$epsilon.squared, nn2_sg17m_8h_e2$epsilon.squared)
e2_lower_ci <- c(nn2_4h_e2$lower.ci, nn2_8h_e2$lower.ci, NN2_4h_8h_e2$lower.ci,sg17m_4h_e2$lower.ci, sg17m_8h_e2$lower.ci, SG17M_4h_8h_e2$lower.ci,nn2_sg17m_4h_e2$lower.ci, nn2_sg17m_4h_e2$lower.ci)
e2_upper_ci <- c(nn2_4h_e2$upper.ci, nn2_8h_e2$upper.ci, NN2_4h_8h_e2$upper.ci,sg17m_4h_e2$upper.ci, sg17m_8h_e2$upper.ci, SG17M_4h_8h_e2$upper.ci,nn2_sg17m_4h_e2$upper.ci, nn2_sg17m_8h_e2$upper.ci)
...
plot_length1 <- ggarrange(nn2_4h_plot_length, nn2_8h_plot_length,sg17m_4h_plot_length, sg18m_8h_plot_length, labels = c("A", "B", "C", "D"), nrow = 1)
